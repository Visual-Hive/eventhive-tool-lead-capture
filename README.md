...
```bash
# 1. Clone this repo
git clone https://github.com/Visual-Hive/eventhive-tool-lead-capture.git
cd eventhive-tool-lead-capture
...
| `TOOL_TITLE` | `Lead Capture` | Title shown inside the tool |
